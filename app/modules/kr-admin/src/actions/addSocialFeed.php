...
/**
 * Add Social Feed (Ex : Twitter feed)
 *
 * This actions permit to admin to add social feed to krypto
 *
 * @package Krypto
...
try {
    ...
    if (empty($_POST) || empty($_POST['kr-social-feed'])) {
    ...
    // Add social feed
    $Social->_addFeed($_POST['kr-social-feed']);
