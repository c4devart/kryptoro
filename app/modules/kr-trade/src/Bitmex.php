...
class Bitmex extends Exchange {
  ...
  public function __construct($User, $App, $Credentials = null){
    ...
    parent::_setExchangeName('bitmex');
  }
  ...
  public function _getApi(){
    ...
    if(!is_null($this->Credentials)){
      $this->Api = new \ccxt\bitmex([
        'apiKey' => App::encrypt_decrypt('decrypt', $this->Credentials["key_bitmex"]),
        'secret' => App::encrypt_decrypt('decrypt', $this->Credentials["secret_bitmex"])
      ]);
    } else {
      $this->Api = new \ccxt\bitmex([
        'apiKey' => App::encrypt_decrypt('decrypt', $this->_isActivated()['key_bitmex']),
        'secret' => App::encrypt_decrypt('decrypt', $this->_isActivated()['secret_bitmex'])
      ]);
    }
  ...
  public function _getName(){ return 'Bitmex'; }
  public function _getTable(){ return 'bitmex_krypto'; }
  public function _getLogo(){ return 'bitmex.png'; }
