...
class Quoinex extends Exchange {
  ...
  public function _getApi(){
    ...
    if(!is_null($this->Credentials)){
      $this->Api = new \ccxt\quoinex([
        'apiKey' => App::encrypt_decrypt('decrypt', $this->Credentials["key_quoinex"]),
        'secret' => App::encrypt_decrypt('decrypt', $this->Credentials["secret_quoinex"])
      ]);
    } else {
      $this->Api = new \ccxt\quoinex([
        'apiKey' => App::encrypt_decrypt('decrypt', $this->_isActivated()['key_quoinex']),
        'secret' => App::encrypt_decrypt('decrypt', $this->_isActivated()['secret_quoinex'])
      ]);
    }
  ...
  public function _getName(){ return 'Quoinex'; }
  public function _getTable(){ return 'quoinex_krypto'; }
  public function _getLogo(){ return 'quoinex.png'; }
