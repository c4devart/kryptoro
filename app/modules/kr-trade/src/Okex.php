...
class Okex extends Exchange {
  ...
  public function _getApi(){
    ...
    if(!is_null($this->Credentials)){
      $this->Api = new \ccxt\okex([
        'apiKey' => App::encrypt_decrypt('decrypt', $this->Credentials["key_okex"]),
        'secret' => App::encrypt_decrypt('decrypt', $this->Credentials["secret_okex"])
      ]);
    } else {
      $this->Api = new \ccxt\okex([
        'apiKey' => App::encrypt_decrypt('decrypt', $this->_isActivated()['key_okex']),
        'secret' => App::encrypt_decrypt('decrypt', $this->_isActivated()['secret_okex'])
      ]);
    }
  ...
  public function _getName(){ return 'Okex'; }
  public function _getTable(){ return 'okex_krypto'; }
  public function _getLogo(){ return 'okex.svg'; }
