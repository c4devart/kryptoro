...
class Bitbank extends Exchange {
  ...
  public function __construct($User, $App, $Credentials = null){
    ...
    parent::_setExchangeName('bitbank');
  }
  ...
  public function _getApi(){
    ...
    if(!is_null($this->Credentials)){
      $this->Api = new \ccxt\bitbank([
        'apiKey' => App::encrypt_decrypt('decrypt', $this->Credentials["key_bitbank"]),
        'secret' => App::encrypt_decrypt('decrypt', $this->Credentials["secret_bitbank"])
      ]);
    } else {
      $this->Api = new \ccxt\bitbank([
        'apiKey' => App::encrypt_decrypt('decrypt', $this->_isActivated()['key_bitbank']),
        'secret' => App::encrypt_decrypt('decrypt', $this->_isActivated()['secret_bitbank'])
      ]);
    }
  ...
  public function _getName(){ return 'Bitbank'; }
  public function _getTable(){ return 'bitbank_krypto'; }
  public function _getLogo(){ return 'bitbank.png'; }
