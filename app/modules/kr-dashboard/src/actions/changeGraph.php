...
try {
    ...
    // Check args given
    if (empty($_POST) || empty($_POST['container']) || empty($_POST['topitem'])) {
    ...
    $DashDashboardTopList->_changeSymbol($_POST['coinsymbol']);
    $DashDashboardTopList->_changeCurrency($_POST['currency']);
    $DashDashboardTopList->_changeMarket($_POST['market']);
    $DashDashboardTopList->_changeContainer($_POST['container']);
